...
const EXTRA_DEVICES = [
  ...
  { name: 'CORP-MAC-103', user: 'linda.p@terralogic.com',   platform: '🍎 macOS 14.4',  status: 'COMPLIANT',     statusCls: 'ok', enrollment: 'DEP',          lastSeen: '5 min'  },
  { name: 'WIN-HR-11',    user: 'raj.k@terralogic.com',     platform: '⊞ Windows 11',   status: 'COMPLIANT',     statusCls: 'ok', enrollment: 'MSI',          lastSeen: '7 min'  },
  { name: 'WIN-HR-12',    user: 'nina.s@terralogic.com',    platform: '⊞ Windows 11',   status: 'NON-COMPLIANT', statusCls: 'cr', enrollment: 'MSI',          lastSeen: '22 min' },
  { name: 'CORP-iPHONE-5',user: 'tom.b@terralogic.com',    platform: '📱 iOS 17.5',     status: 'COMPLIANT',     statusCls: 'ok', enrollment: 'DEP',          lastSeen: '1 min'  },
  { name: 'CORP-iPHONE-6',user: 'claire.d@terralogic.com', platform: '📱 iOS 17.4',     status: 'COMPLIANT',     statusCls: 'ok', enrollment: 'DEP',          lastSeen: '4 min'  },
  { name: 'DROID-OPS-03', user: 'ali.m@terralogic.com',    platform: '🤖 Android 14',   status: 'GRACE PERIOD',  statusCls: 'hi', enrollment: 'Work Profile',  lastSeen: '11 min' },
  { name: 'WIN-DEV-21',   user: 'sven.l@terralogic.com',   platform: '⊞ Windows 10',   status: 'NON-COMPLIANT', statusCls: 'cr', enrollment: 'MSI',          lastSeen: '45 min' },
  { name: 'CORP-MAC-055B',user: 'diana.r@terralogic.com',  platform: '🍎 macOS 13.6',  status: 'COMPLIANT',     statusCls: 'ok', enrollment: 'DEP',          lastSeen: '9 min'  },
  { name: 'CORP-iPAD-23', user: 'leon.h@terralogic.com',   platform: '📱 iPadOS 17.3', status: 'COMPLIANT',     statusCls: 'ok', enrollment: 'DEP',          lastSeen: '2 min'  },
]
