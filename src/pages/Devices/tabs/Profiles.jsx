...
const PROFILES = [
  ...
  { name: 'Corporate Wi-Fi',          type: 'Wifi',        platform: 'All',          assigned: 847, installed: 847, cls: 'ok', status: 'ACTIVE',  updated: '2026-05-14' },
...
const TYPE_COLORS = {
  Security: 'var(--crit)', Wifi: 'var(--info)', VPN: 'var(--high)',
