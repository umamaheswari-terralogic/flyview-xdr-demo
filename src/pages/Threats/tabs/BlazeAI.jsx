const INSIGHTS = [
  ...
  },
  {
    ...
    priority: 'MEDIUM',
    priorityCls: 'me',
    title: 'Insider risk pattern — shabbeer (PIP employee)',
    summary: 'User shabbeer (currently on PIP) downloaded 4.2 GB from SharePoint at 02:31 AM. Combined with recent large Google Drive activity and a resignation mention in a monitored communication, Blazey AI classifies this as a potential data theft scenario.',
