...
router.get('/sim', (_req, res) => {
  ...
  if (!simState.antivirusCompliant) {
    incidents.push({
      ...
      detail:        'MDM: Antivirus disabled · Device is exposed to malware and ransomware · TVyshnavi-3941',
  ...
  if (!simState.deviceCompliant) {
    ...
    incidents.push({
      ...
      detail:        `MDM: Blocked app installed · AI-SPM: ${aiExts[0] ?? 'AI extension'} detected · Device: TVyshnavi-3941`,
